...
if __name__ == "__main__":
    em = EmployeeManager()
    em.add_employee(EmployeeCreate(emp_id=em.get_next_emp_id(), name="Kritika", manager_id=None))
    em.add_employee(EmployeeCreate(emp_id=em.get_next_emp_id(), name="Rudhra", manager_id="E001"))
    #emp_id_Rudhra = em.search_employee_by_name("Rudhra")[0]
